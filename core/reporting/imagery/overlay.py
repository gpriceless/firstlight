"""
Detection overlay rendering for FirstLight visualizations (VIS-1.3 Task 2.1).

This module blends detection masks (flood/fire) onto satellite imagery backgrounds
with configurable transparency, severity colormaps, and optional polygon outlines.
